...
public class DylanVariableProcessor extends BaseScopeProcessor {
  ...
  public boolean execute(@NotNull PsiElement psiElement, ResolveState resolveState) {
    ...
    boolean inFunctionDefinition = PsiTreeUtil.isAncestor(functionDefinition, psiElement, false);
    boolean inMethodDefinition = PsiTreeUtil.isAncestor(methodDefinition, psiElement, false);
    boolean inLocalDeclaration = inLeftPartOfLocalDeclaration(psiElement);

    boolean inFunction = (inFunctionDefinition || inMethodDefinition) && inLocalDeclaration;
